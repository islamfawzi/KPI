...
<div ng-app="app">
    ...
    <form method="post" action="" ng-controller="kpiCtrl" >
        ...
        <div>    
            <select name="table_id" class="form-control" ng-model="table_id" ng-init="table_id = '<%=kpi.getTable_id()%>'" ng-change="onChangeSheet()">
        ...
        <div ng-hide="x_axis | isEmpty" > 
            ...
            <select name="x_axis" class="form-control"  >
                ...
                <option ng-repeat="(key, value) in x_axis" ng-selected="key == '<%=kpi.getX_axis()%>'" value="{{key}}">{{value}}</option>
            </select>
